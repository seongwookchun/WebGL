...
function main() {
  ...
  // Draw the triangles
  gl.drawArrays(gl.TRIANGLES, 0, 3);   // The green triangle
    gl.polygonOffset(1.0, 1.0);          // Set the polygon offset  
  gl.drawArrays(gl.TRIANGLES, 3, 6); // The yellow triangle
        gl.polygonOffset(1.0, 1.0);          // Set the polygon offset  

  gl.drawArrays(gl.TRIANGLES, 6, 9); // The yellow triangle
          gl.polygonOffset(1.0, 1.0);          // Set the polygon offset  
...
function initVertexBuffers(gl) {
  ...
  var verticesColors = new Float32Array([
    ...
    -3.0, -3.0,  -5.0,  1.0,  1.0,  0.4,
     ...
     0.0*scale,  3.0*scale,  -5.0,  0.0,  0.4,  0.4, // The yellow triagle
    -3.0*scale, -3.0*scale,  -5.0,  0.0,  1.0,  0.4,
     3.0*scale, -3.0*scale,  -5.0,  0.0,  1.0,  0.4, 
  ]);
  var n = 9;
