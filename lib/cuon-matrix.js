...
function sphericalVector(phi, theta) {
  var e, f, sinTh, cosTh, sinPh, cosPh, phi, theta;
  phi = phi *(Math.PI/180) ;
  theta = theta *(Math.PI/180) ;
  f = new Vector4([0,0,0,1]);
  e = f.elements;
  ...
  console.log('inside sphericalVector func, e array', e);
  console.log(Math.PI);
  return e;
}

console.log('hi here is cuon matrix console');
console.log('sphericalVector test', sphericalVector(45, 0))


for (i=0; i<20; i++) {
    degree = 360/20 * i;
    console.log('over than 90 degree sine and cosine', Math.sin((90+ degree)*(Math.PI/180)))
    console.log('and sphericalVector(degree, 0)', sphericalVector(degree, 90)*(Math.PI/180));
}

console.log('over 360 degree of sine', Math.cos(360*(Math.PI/180)), Math.cos(361*(Math.PI/180)));